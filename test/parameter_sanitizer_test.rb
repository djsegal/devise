...
class ParameterSanitizerTest < ActiveSupport::TestCase
  ...
  test 'permits news parameters for an existing operation' do
  ...
  test 'permits news parameters for an existing operation with a block' do
    sanitizer = sanitizer('user' => { 'username' => 'jose' })
  ...
  test 'permit parameters for new operations' do
  ...
  test 'fails when we do not have any permitted parameters for the operation' do
